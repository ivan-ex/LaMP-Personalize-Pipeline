...
parser.add_argument('--model_name', type=str, default='/data1/xuyifan/model/meta-llama/llama2_7b_hf')
...
with open(f"./data/movie_tagging/user_top_100_history.json", 'r') as f:
...
if args.add_profile:
    output_path = './output/{}/output-OPPU-k{}-{}-{}-profile.json'.format(args.k, args.task_name, args.task_name, model_name.split('/')[-1])
    ensure_parent_dir(output_path)
    with open(output_path, 'w') as f:
        json.dump(output_file, f, indent=4)
else:
    output_path = './output/{}/output-OPPU-k{}-{}-{}.json'.format(args.k, args.task_name, args.task_name, model_name.split('/')[-1])
    ensure_parent_dir(output_path)
    with open(output_path, 'w') as f:
        json.dump(output_file, f, indent=4)
